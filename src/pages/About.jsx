    ...
    <div className="min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-20">
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-6 sm:p-8 space-y-8">
        ...
        <p className="text-gray-700 text-base sm:text-lg max-w-3xl mx-auto">
          Welcome to <span className="font-semibold text-red-600">MY SHOP</span>, where convenience meets choice. 
          Discover a world of products at your fingertips, anytime, anywhere. Our shopping app brings the joy of 
          effortless shopping to your pocket. From daily essentials to trendy finds, we make it simple and fast.
        </p>
        ...
        <div className="space-y-4 sm:space-y-6 max-w-3xl mx-auto">
          ...
          <p className="text-gray-700 text-sm sm:text-base">
            At <span className="font-semibold text-red-600">MY SHOP</span>, our mission is to make shopping simple and enjoyable 
            for everyone. Explore a wide range of products, find the best deals, and have them delivered right to your doorstep.
          </p>
        </div>
        ...
        <div className="space-y-4 sm:space-y-6 max-w-3xl mx-auto">
          <h2 className="text-xl sm:text-2xl font-semibold text-red-600">
            Why Choose <span className="font-semibold text-red-600">MY SHOP</span>?
          </h2>
        ...
        <div className="space-y-4 sm:space-y-6 max-w-3xl mx-auto">
          ...
          <p className="text-gray-700 text-sm sm:text-base">
            To create a seamless and delightful shopping experience where users can discover, compare, 
            and buy products effortlessly. We strive to become the go-to app for smart, convenient, 
            and enjoyable shopping for everyone.
          </p>
        </div>
        ...
        <div className="text-center mt-8 sm:mt-10 max-w-md mx-auto px-4">
          ...
          <p className="text-gray-700 mb-4 text-sm sm:text-base">
            Whether you’re looking for something that you want <br /> 
            <span className="font-semibold text-red-600">MY SHOP</span> <br /> 
